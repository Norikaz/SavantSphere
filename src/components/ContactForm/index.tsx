	...
	return (
		<div className="contact-form-container">
			...
			<div className="input-group">
				...
				<Input type="text" placeholder="e.g. John Doe" className="large-input" />
				<Label htmlFor="email" className="contact-form-labels">
					Email
				</Label>
			</div>
			<div className="input-group">
				<Input type="email" placeholder="e.g. johndoe@example.com" className="large-input" />
			</div>
			<div className="input-group">
				<Label htmlFor="number" className="contact-form-labels">
					Number
				</Label>
				<Input type="tel" placeholder="e.g. 999-999-9999" className="large-input" />
			</div>
